  ...
  if (error) {
    return (
      <div className="flex flex-col items-center justify-center gap-4 py-24">
        <p className="text-sm text-[#80848e]">データの取得に失敗しました</p>
        <button
          onClick={() => void load()}
                ...
                {activeSessions.map((s) => (
                  ...
                  >
                    ...
                    <div className="min-w-0">
                      ...
                      <p className="text-[10px] text-[#80848e]">{s.memberCount}人</p>
                    </div>
                  </div>
                ))}
              </div>
        ...
        <div className="lg:col-span-2">
          <div className="sticky top-[57px] rounded-lg bg-[#383a40] overflow-hidden">
            <div className="flex items-center justify-between border-b border-[#1e1f22] px-4 py-3">
              ...
              <a
                href="/logs"
                className="flex items-center gap-1 text-xs text-[#80848e] hover:text-[#5865f2] transition-colors"
              >
                すべて見る
            ...
            {recentLogs.length === 0 ? (
              ...
              <ul className="max-h-[calc(100vh-12rem)] divide-y divide-[#1e1f22]/60 overflow-y-auto">
                {recentLogs.slice(0, 30).map((log) => {
                  ...
                  return (
                    <li key={log.id} className="flex items-start gap-3 px-4 py-2.5 hover:bg-[#404249] transition-colors">
                      ...
                      <span className="shrink-0 text-[10px] text-[#4e5058] mt-0.5 whitespace-nowrap">
